...
Text {
    ...
    font.pixelSize: if(api.memory.has(CONSTANTS.MAIN_TEXTSIZE) && CONFIGS.getMainTextsize(api) == 1){return scaled(28)*0.95}
	else if(api.memory.has(CONSTANTS.MAIN_TEXTSIZE) && CONFIGS.getMainTextsize(api) == 2){return scaled(28)*0.9}
	else if(api.memory.has(CONSTANTS.MAIN_TEXTSIZE) && CONFIGS.getMainTextsize(api) == 3){return scaled(28)*0.8}
	else {return scaled(28)}
