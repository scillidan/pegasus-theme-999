...
Text {
    ...
    color: if(api.memory.has(CONSTANTS.MAIN_COLOUR) && api.memory.get(CONSTANTS.MAIN_COLOUR) == '极致复古' ){return "#f4b776" }
	// else if(api.memory.has(CONSTANTS.MAIN_COLOUR) && api.memory.get(CONSTANTS.MAIN_COLOUR) == '流浪地球' ){return "#f4b776" }
	else {return "#ffffff"}
